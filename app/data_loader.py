...
def process_applicant_record(app_id: str, app_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "nivel_profissional": clean_empty_values(
            professional_info.get("nivel_profissional")
        ),
        "area_atuacao": clean_empty_values(professional_info.get("area_atuacao")),
        "conhecimentos_tecnicos": clean_empty_values(
            professional_info.get("conhecimentos_tecnicos")
        ),
...
def process_vaga_record(vaga_id: str, vaga_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "solicitante_cliente": clean_empty_values(
            basic_info.get("solicitante_cliente")
        ),
        ...
        "analista_responsavel": clean_empty_values(
            basic_info.get("analista_responsavel")
        ),
        ...
        "limite_contratacao": clean_empty_values(
            basic_info.get("limite_esperado_para_contratacao")
        ),
        ...
        "nivel_profissional": clean_empty_values(
            profile_info.get("nivel profissional")
        ),
        ...
        "principais_atividades": clean_empty_values(
            profile_info.get("principais_atividades")
        ),
        "competencias": clean_empty_values(
...
def process_prospect_record(
    prospect_id: str, prospect_data: Dict[str, Any]
) -> List[Dict[str, Any]]:
